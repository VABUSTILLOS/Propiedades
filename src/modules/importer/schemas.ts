...
export const importedPropertyDraftSchema = z.object({
  ...
  recamaras: z.number().int().positive().nullable().default(null),
  banos: z.number().int().positive().nullable().default(null),
  estacionamientos: z.number().int().positive().nullable().default(null),
  antiguedad: z.number().int().positive().nullable().default(null),
