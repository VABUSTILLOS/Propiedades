#!/usr/bin/env node
/**
 * extract-44.mjs — extract venta listings (≤ $3,000,000 MXN) from the
 ...
 *
 * Usage: node scripts/extract-44.mjs [--out file.jsonl] [--dir /tmp/captures-44]
 */
import fs from "node:fs";

const MAX_PRICE = 3_000_000;
const CAPTURE_DIR = process.argv.find((a) => a.startsWith("--dir="))?.split("=")[1] ?? "/tmp/captures-44";
const OUT =
  process.argv.find((a) => a.startsWith("--out="))?.split("=")[1] ??
  ".scrape/propiedades-com/dataset-44.jsonl";
