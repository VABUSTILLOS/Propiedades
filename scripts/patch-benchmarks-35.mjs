#!/usr/bin/env node
/**
 * Populate market_benchmarks for 1 newly-imported propiedades.com colonias
 * (dataset 35) that lacked benchmark coverage.
 *
 ...
 * avg_price_m2_land = 0.
 *
 * Usage: node scripts/patch-benchmarks-35.mjs
 */
...
async function main() {
  ...
  const curated = JSON.parse(fs.readFileSync(path.join(root, 'scripts/benchmark-curated-35.json'), 'utf8'));
