#!/usr/bin/env node
/**
 * Populate market_benchmarks for 18 newly-imported propiedades.com colonias
 * (dataset 34) that lacked benchmark coverage.
 *
...
async function main() {
  ...
  const curated = JSON.parse(fs.readFileSync(path.join(root, 'scripts/benchmark-curated-34.json'), 'utf8'));
