 ...
 * (Chihuahua, ≤ $3,000,000 MXN) discovered among dataset-36 imports that
...
async function main() {
  ...
  const curated = JSON.parse(fs.readFileSync(path.join(root, 'scripts/benchmark-curated-36.json'), 'utf8'));
